...
export default function Home() {
    return (
        <div className="relative min-h-screen">
            <div
                className="relative h-[100vh] w-full overflow-hidden bg-[url(/banner2.png)] bg-no-repeat bg-cover bg-center">
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="w-full md:w-2/3 lg:w-2/3 space-y-12 md:space-y-6">
                            ...
                            <p className="text-white font-medium text-base sm:text-lg md:text-xl lg:text-2xl max-w-xl">
                                Nous sommes une société engagée dans la vente d'arbres de qualité et la participation
                                active à la reforestation.
                            </p>
