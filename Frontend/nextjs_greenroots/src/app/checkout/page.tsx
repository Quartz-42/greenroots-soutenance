...
import Recapitulatif from "@/components/checkout/Reacapitulatif"
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    const isValid = validateForm(firstName, lastName, address, city, zipCode, setErrors);
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Recapitulatif cartItems={cartItems} roundedSubtotal={roundedSubtotal} roundedTva={roundedTva} roundedTotal={roundedTotal} loading={loading} formValid={formValid} handleSubmit={triggerSubmit} />
          </div>
        </div>
      </main>
